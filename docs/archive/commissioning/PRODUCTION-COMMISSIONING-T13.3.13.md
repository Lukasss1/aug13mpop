# Milk Pop T13.3.13 — Production Commissioning
...
The current candidate is `r4.10.6-t13.3.13-staff-portal-integrity`. It contains 104 ordered upgrade migrations, 106 fresh-install SQL entries and 17 Edge Functions. T13.3.13 adds the bounded StaffPortal identity/SIFR/checklist/clock integrity migration; it does not change the production commissioning sequence below.
