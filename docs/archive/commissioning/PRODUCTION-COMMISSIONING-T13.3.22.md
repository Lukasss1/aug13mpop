# Milk Pop T13.3.22 — Public Website Commissioning
...
This is the current commissioning authority for `r4.10.10-t13.3.22-public-web`.
...
T13.3.22 specifically proves that a genuine store with a real name, address and postcode can appear as `coming_soon` before POS/trading setup, while `setup_status` remains private and continues to protect trading operations.
