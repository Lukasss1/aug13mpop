# Milk Pop T13.3.27 — Public Website Commissioning

> **HISTORICAL / SUPERSEDED.** This document records the pre-production verifier closure. Use [`../../../PRODUCTION-COMMISSIONING-T13.3.30.md`](../../../PRODUCTION-COMMISSIONING-T13.3.30.md) for current production commissioning.

## Scope

This is the current commissioning authority for `r4.10.14-t13.3.27-verifier-closure`.
...
## T13.3.27 verifier closure

T13.3.27 changes no application, database, permission, storage, e-mail or Edge Function business logic. It closes two stale verification assertions left behind when POS/Web Till was deliberately deferred from the public-web release:

- the POS contract now proves the retained ledger remains role-scoped **and is not routed**;
- the historical Till-boundary contract now proves the README states the current deferred, undeployed launch scope.

The protected verifier must pass both contracts before build, signing or deployment. POS remains source-preserved and absent from the 14-function public deployment.
